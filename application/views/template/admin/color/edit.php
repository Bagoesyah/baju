...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('admin/color'); ?>"><?php echo ucwords('color'); ?></a></li>
            ...
            <div class="box-body">
                <?php alert_message(); ?>
                                        ...
                                        <div class="form-group <?php echo form_error('title') ? 'has-error' : ''; ?>">
                                            ...
                                            <input type="text" name="title" id="title" class="form-control" placeholder="Enter Title" value="<?php echo isset($color) ? $color->title : set_value('title'); ?>">
