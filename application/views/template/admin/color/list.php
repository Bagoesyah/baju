...
# @Last modified time: 2017-03-03T15:36:08+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="colorModule" ng-controller="colorController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/color/add'); ?>" class="btn btn-primary btn-sm">Add color</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/color/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('colorModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/color/get_data'); ?>")
...
app.controller('colorController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/color/delete'); ?>" + "/" + row.id);
