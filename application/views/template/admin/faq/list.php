...
# @Last modified time: 2017-02-20T14:00:28+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="faqModule" ng-controller="faqController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/faq/add'); ?>" class="btn btn-primary btn-sm">Add faq</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    ...
                    <tr>
                        <th><input st-search="question" placeholder="Search.." class="input-sm form-control"></th>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/faq/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Question</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.question }}</td>
                    </tr>

                    <tr>
                        <th>Answer</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.answer }}</td>
                    </tr>
...
<script>
var app = angular.module('faqModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/faq/get_data'); ?>")
...
app.controller('faqController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/faq/delete'); ?>" + "/" + row.id);
