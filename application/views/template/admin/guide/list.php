...
# @Last modified time: 2017-02-26T23:15:44+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="guideModule" ng-controller="guideController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/guide/add'); ?>" class="btn btn-primary btn-sm">Add guide</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/guide/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Image</th>
                        <td width="10">:</td>
                        <td><img src="<?php echo base_url(path_image('guide_path') . '{{ selected.item.image }}'); ?>" width="150"></td>
                    </tr>
...
<script>
var app = angular.module('guideModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/guide/get_data'); ?>")
...
app.controller('guideController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/guide/delete'); ?>" + "/" + row.id);
