...
# @Last modified time: 2017-04-26T11:17:39+07:00
?>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo site_url('admin/information'); ?>"><?php echo ucwords('information'); ?></a></li>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group <?php echo form_error('title') ? 'has-error' : ''; ?>">
                    ...
                    <input type="text" name="title" id="title" class="form-control" placeholder="Enter Title" value="<?php echo isset($information) ? $information->title : set_value('title'); ?>">
                ...
                <div class="form-group <?php echo form_error('content') ? 'has-error' : ''; ?>">
                    ...
                    <textarea name="content" id="ckeditor" class="form-control" placeholder="Enter Content">
                        <?php echo isset($information) ? $information->content : set_value('content'); ?>
                    </textarea>
