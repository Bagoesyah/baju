...
# @Last modified time: 2017-04-26T11:17:30+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="informationModule" ng-controller="informationController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/information/add'); ?>" class="btn btn-primary btn-sm">Add information</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/information/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('informationModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/information/get_data'); ?>")
...
app.controller('informationController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/information/delete'); ?>" + "/" + row.id);
