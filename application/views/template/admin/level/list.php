<?php
# @Author: Awan Tengah
# @Date:   2017-01-18T15:32:10+07:00
# @Last modified by:   Awan Tengah
# @Last modified time: 2017-01-20T19:28:46+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="levelModule" ng-controller="levelController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/level/add'); ?>" class="btn btn-primary btn-sm">
                        Add level
                    </a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <th st-sort="redirect">Redirect</th>
                    ...
                    <tr>
                        ...
                        <th><input st-search="redirect" placeholder="Search.." class="input-sm form-control"></th>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/level/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('levelModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/level/get_data'); ?>")
...
app.controller('levelController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/level/delete'); ?>" + "/" + row.id);
