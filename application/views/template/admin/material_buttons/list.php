...
# @Last modified time: 2017-05-02T19:41:06+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="buttonsModule" ng-controller="buttonsController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-buttons/add'); ?>" class="btn btn-primary btn-sm">Add buttons</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <th st-sort="category_text">Category</th>
                    ...
                    <tr>
                        <th><input st-search="category_text" placeholder="Search.." class="input-sm form-control"></th>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-buttons/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Image</th>
                        <td width="10">:</td>
                        <td><img ng-src="<?php echo base_url(path_image('material_buttons_path') . '{{ selected.item.image }}'); ?>"></td>
                    </tr>
                    ...
                    <tr>
                        <th>Need Stock For Custom</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.need_stock_for_custom }}</td>
                    </tr>
...
<script>
var app = angular.module('buttonsModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material-buttons/get_data'); ?>")
...
app.controller('buttonsController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material-buttons/delete'); ?>" + "/" + row.id);
