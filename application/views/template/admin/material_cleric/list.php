...
# @Last modified time: 2017-05-02T19:50:41+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="material_clericModule" ng-controller="material_clericController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-cleric/add'); ?>" class="btn btn-primary btn-sm">Add material cleric</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <th st-sort="category">Title</th>
                        <th st-sort="fabric">Fabric Code</th>
                    ...
                    <tr>
                        <th><input st-search="category" placeholder="Search.." class="input-sm form-control"></th>
                        <th><input st-search="fabric" placeholder="Search.." class="input-sm form-control"></th>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-cleric/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('material_clericModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material_cleric/get_data'); ?>")
...
app.controller('material_clericController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material_cleric/delete'); ?>" + "/" + row.id);
