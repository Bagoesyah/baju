...
# @Last modified time: 2017-04-24T15:22:15+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="material_cleric_sub_categoryModule" ng-controller="material_cleric_sub_categoryController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-cleric-sub-category/add'); ?>" class="btn btn-primary btn-sm">Add cleric sub category</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-cleric-sub-category/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('material_cleric_sub_categoryModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material_cleric_sub_category/get_data'); ?>")
...
app.controller('material_cleric_sub_categoryController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material_cleric_sub_category/delete'); ?>" + "/" + row.id);
