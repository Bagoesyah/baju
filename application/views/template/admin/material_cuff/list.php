...
# @Last modified time: 2017-05-02T19:21:18+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="cuffModule" ng-controller="cuffController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-cuff/add'); ?>" class="btn btn-primary btn-sm">Add cuff</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-cuff/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Image</th>
                        <td width="10">:</td>
                        <td><img ng-src="<?php echo base_url(path_image('material_cuff_path') . '{{ selected.item.image }}'); ?>"></td>
                    </tr>
...
<script>
var app = angular.module('cuffModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material-cuff/get_data'); ?>")
...
app.controller('cuffController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material-cuff/delete'); ?>" + "/" + row.id);
