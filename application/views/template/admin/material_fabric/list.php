...
# @Last modified time: 2017-03-21T13:02:04+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="fabricModule" ng-controller="fabricController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-fabric/add'); ?>" class="btn btn-primary btn-sm">Add fabric</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <th st-sort="code_fabric">Code Fabric</th>
                    ...
                    <tr>
                        <th><input st-search="code_fabric" placeholder="Search.." class="input-sm form-control"></th>
                        <th><input st-search="title" placeholder="Search.." class="input-sm form-control"></th>
                        <th><input st-search="price" placeholder="Search.." class="input-sm form-control"></th>
                        <th><input st-search="stock" placeholder="Search.." class="input-sm form-control"></th>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-fabric/edit/{{row.id}}'); ?>">
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th width="150">Code Fabric</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.code_fabric }}</td>
                    </tr>

                    <tr>
                        <th>Category</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.category_text }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="10">:</td>
                        <td>{{ selected.item.color_pattern }}</td>
                    </tr>

                    <tr>
                        <th>Mixing Ratio</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.mixing_ratio }}</td>
                    </tr>

                    <tr>
                        <th>Origin</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.origin }}</td>
                    </tr>

                    <tr>
                        <th>Price</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.price }}</td>
                    </tr>
                    ...
                    <tr>
                        <th>Image</th>
                        <td width="10">:</td>
                        <td><img ng-src="<?php echo base_url(path_image('material_fabric_path') . '{{ selected.item.thumb }}'); ?>"></td>
                    </tr>
...
<script>
var app = angular.module('fabricModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material-fabric/get_data'); ?>")
...
app.controller('fabricController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material-fabric/delete'); ?>" + "/" + row.id);
