...
# @Last modified time: 2017-03-19T13:08:24+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="material_modelModule" ng-controller="material_modelController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-model/add'); ?>" class="btn btn-primary btn-sm">Add material model</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-model/edit/{{row.id}}'); ?>">
                ...
                <tfoot>
                    <tr>
                        ...
                        st-items-by-page="<?php echo isset($limit) ? $limit : 10; ?>" colspan="4">
                    </td>
                </tr>
            </tfoot>
        </table>
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Image</th>
                        <td width="10">:</td>
                        <td><img src="<?php echo base_url(path_image('material_model_path') . '{{ selected.item.image }}'); ?>" width="100"></td>
                    </tr>
...
<script>
var app = angular.module('material_modelModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material_model/get_data'); ?>")
...
app.controller('material_modelController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material_model/delete'); ?>" + "/" + row.id);
