...
# @Last modified time: 2017-02-27T21:44:43+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="material_neck_sizeModule" ng-controller="material_neck_sizeController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-neck-size/add'); ?>" class="btn btn-primary btn-sm">Add material neck size</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-neck-size/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('material_neck_sizeModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material_neck_size/get_data'); ?>")
...
app.controller('material_neck_sizeController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material_neck_size/delete'); ?>" + "/" + row.id);
