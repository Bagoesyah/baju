...
# @Last modified time: 2017-05-02T20:04:21+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="material_optionModule" ng-controller="material_optionController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-option/add'); ?>" class="btn btn-primary btn-sm">Add option</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-option/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Image</th>
                        <td width="10">:</td>
                        <td><img src="<?php echo base_url(path_image('material_option_path') . '{{ selected.item.image }}') ?>"></td>
                    </tr>
...
<script>
var app = angular.module('material_optionModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material_option/get_data'); ?>")
...
app.controller('material_optionController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material_option/delete'); ?>" + "/" + row.id);
