...
# @Last modified time: 2017-02-28T14:50:17+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="material_shoulder_widthModule" ng-controller="material_shoulder_widthController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-shoulder-width/add'); ?>" class="btn btn-primary btn-sm">Add material shoulder width</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-shoulder-width/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('material_shoulder_widthModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material_shoulder_width/get_data'); ?>")
...
app.controller('material_shoulder_widthController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material_shoulder_width/delete'); ?>" + "/" + row.id);
