...
# @Last modified time: 2017-02-27T22:58:09+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="material_sleeve_typeModule" ng-controller="material_sleeve_typeController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/material-sleeve-type/add'); ?>" class="btn btn-primary btn-sm">Add material sleeve type</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/material-sleeve-type/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('material_sleeve_typeModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/material_sleeve_type/get_data'); ?>")
...
app.controller('material_sleeve_typeController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/material_sleeve_type/delete'); ?>" + "/" + row.id);
