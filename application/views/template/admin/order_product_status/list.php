...
# @Last modified time: 2017-03-31T15:09:39+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="order_product_statusModule" ng-controller="order_product_statusController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/order-product-status/add'); ?>" class="btn btn-primary btn-sm">Add order status</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/order-product-status/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('order_product_statusModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/order_product_status/get_data'); ?>")
...
app.controller('order_product_statusController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/order_product_status/delete'); ?>" + "/" + row.id);
