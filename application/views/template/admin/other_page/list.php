...
<div class="content-wrapper" ng-app="other_pageModule" ng-controller="other_pageController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/other-page/add'); ?>" class="btn btn-primary btn-sm">Add other page</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/other-page/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr ng-if="selected.item.header_image != ''">
                        <th width="150">Header Image</th>
                        <td width="10">:</td>
                        <td><img ng-src="<?php echo base_url(path_image('other_page_path') . '{{ selected.item.header_image }}'); ?>" width="100"></td>
                    </tr>
                    ...
                    <tr>
                        <th>Content</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.content | htmlToPlaintext}}</td>
                    </tr>
...
<script>
var app = angular.module('other_pageModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/other_page/get_data'); ?>")
...
app.controller('other_pageController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/other_page/delete'); ?>" + "/" + row.id);
