...
# @Last modified time: 2017-04-06T21:08:51+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="payment_listModule" ng-controller="payment_listController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/payment-list/add'); ?>" class="btn btn-primary btn-sm">Add payment list</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <th st-sort="bank_name">Bank Name</th>
                        <th st-sort="account_name">Account Name</th>
                        <th width="160" st-sort="created_at">Created At</th>

                        <th width="110" rowspan="2" class="th-top">Action</th>
                    </tr>
                    <tr>
                        <th><input st-search="bank_name" placeholder="Search.." class="input-sm form-control"></th>
                        <th><input st-search="account_name" placeholder="Search.." class="input-sm form-control"></th>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/payment-list/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Bank Name</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.bank_name }}</td>
                    </tr>

                    <tr>
                        <th>Account Name</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.account_name }}</td>
                    </tr>

                    <tr>
                        <th>No Rek</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.no_rek }}</td>
                    </tr>
...
<script>
var app = angular.module('payment_listModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/payment_list/get_data'); ?>")
...
app.controller('payment_listController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/payment_list/delete'); ?>" + "/" + row.id);
