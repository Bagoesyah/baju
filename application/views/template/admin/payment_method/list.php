...
# @Last modified time: 2017-02-23T14:51:07+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="payment_methodModule" ng-controller="payment_methodController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/payment-method/add'); ?>" class="btn btn-primary btn-sm">Add payment method</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/payment-method/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('payment_methodModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/payment_method/get_data'); ?>")
...
app.controller('payment_methodController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/payment_method/delete'); ?>" + "/" + row.id);
