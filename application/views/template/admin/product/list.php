...
# @Last modified time: 2017-02-06T17:42:36+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="productModule" ng-controller="productController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/product/add'); ?>" class="btn btn-primary btn-sm">Add product</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    ...
                    <tr>
                        <th>
                            <select st-search="id_product_category" class="input-sm form-control">
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/product/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Slug</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.slug }}</td>
                    </tr>

                    <tr>
                        <th>Description</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.description | htmlToPlaintext }}</td>
                    </tr>
...
<script>
var app = angular.module('productModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/product/get_data'); ?>")
...
app.controller('productController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/product/delete'); ?>" + "/" + row.id);
