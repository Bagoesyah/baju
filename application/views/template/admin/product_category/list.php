...
# @Last modified time: 2017-02-06T16:52:34+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="product_categoryModule" ng-controller="product_categoryController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/product-category/add'); ?>" class="btn btn-primary btn-sm">Add product category</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/product-category/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('product_categoryModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/product_category/get_data'); ?>")
...
app.controller('product_categoryController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/product_category/delete'); ?>" + "/" + row.id);
