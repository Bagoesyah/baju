...
<div class="content-wrapper" ng-app="promoModule" ng-controller="promoController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/promo/add'); ?>" class="btn btn-primary btn-sm">Add Promo</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <th st-sort="promo_name">Name</th>
                        <th width="160" st-sort="created_at">Created At</th>

                        <th width="110" rowspan="2" class="th-top">Action</th>
                    </tr>
                    <tr>
                        <th><input st-search="promo_name" placeholder="Search.." class="input-sm form-control"></th>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/promo/edit/{{row.id}}'); ?>">
        ...
        <div class="table-responsive">
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr ng-if="selected.item.header_image != ''">
                        <th width="150">Banner</th>
                        <td width="10">:</td>
                        <td><img ng-src="<?php echo base_url(path_image('promo_path') . '{{ selected.item.image }}'); ?>" width="100"></td>
                    </tr>

                    <tr>
                        <th>Name</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.promo_name }}</td>
                    </tr>

                    <tr>
                        <th>Type Promo</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.type_name }}</td>
                    </tr>
                    ...
                    <tr ng-if="selected.item.status==0">
                        <th>Status</th>
                        <td width="10">:</td>
                        <td>Draft</td>
                    </tr>

                    <tr ng-if="selected.item.status==1">
                        <th>Status</th>
                        <td width="10">:</td>
                        <td>Publish</td>
                    </tr>
...
<script>
var app = angular.module('promoModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/promo/get_data'); ?>")
...
app.controller('promoController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/promo/delete'); ?>" + "/" + row.id);
