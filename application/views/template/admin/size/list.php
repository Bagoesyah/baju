...
# @Last modified time: 2017-04-20T20:44:50+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="sizeModule" ng-controller="sizeController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/size/add'); ?>" class="btn btn-primary btn-sm">Add size</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    <tr>
                        ...
                        <th st-sort="fabric_needed">Fabric Needed</th>
                    ...
                    <tr>
                        ...
                        <th><input st-search="fabric_needed" placeholder="Search.." class="input-sm form-control"></th>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/size/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Neck</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.neck }}</td>
                    </tr>

                    <tr>
                        <th>Shoulder</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.shoulder }}</td>
                    </tr>

                    <tr>
                        <th>Chest</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.chest }}</td>
                    </tr>

                    <tr>
                        <th>Waist</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.waist }}</td>
                    </tr>

                    <tr>
                        <th>Hip</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.hip }}</td>
                    </tr>

                    <tr>
                        <th>Arm Hole</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.arm_hole }}</td>
                    </tr>

                    <tr>
                        <th>Back Length (~88cm)</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.back_length_88 }}</td>
                    </tr>

                    <tr>
                        <th>Back Length (89cm~)</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.back_length_89 }}</td>
                    </tr>

                    <tr>
                        <th>Aloha (~88cm)</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.aloha_88 }}</td>
                    </tr>

                    <tr>
                        <th>Aloha (89cm~)</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.aloha_89 }}</td>
                    </tr>

                    <tr>
                        <th>Cuffs Circle</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.cuffs_circle }}</td>
                    </tr>

                    <tr>
                        <th>Short Sleeve</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.short_sleeve }}</td>
                    </tr>

                    <tr>
                        <th>Sleeve Circle</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.sleeve_circle }}</td>
                    </tr>

                    <tr>
                        <th>Fabric Needed</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.fabric_needed }}</td>
                    </tr>
...
<script>
var app = angular.module('sizeModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/size/get_data'); ?>")
...
app.controller('sizeController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/size/delete'); ?>" + "/" + row.id);
