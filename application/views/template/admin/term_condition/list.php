...
# @Last modified time: 2017-02-20T14:01:16+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="term_conditionModule" ng-controller="term_conditionController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/term-condition/add'); ?>" class="btn btn-primary btn-sm">Add term condition</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/term-condition/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('term_conditionModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/term_condition/get_data'); ?>")
...
app.controller('term_conditionController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/term_condition/delete'); ?>" + "/" + row.id);
