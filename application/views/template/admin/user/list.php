...
# @Last modified time: 2017-02-06T15:31:36+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="userModule" ng-controller="userController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/user/add'); ?>" class="btn btn-primary btn-sm">Add User</a>
                <?php endif; ?>
            ...
            <div class="box-body table-responsive">
                ...
                <thead>
                    ...
                    <tr>
                        ...
                        <th><input st-search="level" placeholder="Search.." class="input-sm form-control"></th>
                            ...
                            <td class="td-action">
                                ...
                                <ul class="dropdown-menu ul-action" role="menu">
                                    <?php if (isset($_updated) == 1): ?>
                                        <li>
                                            <a href="<?php echo site_url('admin/user/edit/{{row.id}}'); ?>">
            ...
            <table class="table table-hover">
                <tbody>
                    ...
                    <tr>
                        <th>Level</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.level }}</td>
                    </tr>
                    <tr>
                        <th>Status</th>
                        <td width="10">:</td>
                        <td>{{ selected.item.status == 1 ? 'Active' : 'Non Active' }}</td>
                    </tr>
...
<script>
var app = angular.module('userModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/user/get_data'); ?>")
...
app.controller('userController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/user/delete'); ?>" + "/" + row.id);
