...
# @Last modified time: 2017-02-22T21:20:27+07:00
?>

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper" ng-app="user_categoryModule" ng-controller="user_categoryController as mc">
        ...
        <div class="box">
            <div class="box-header">
                <?php if (isset($_created) == 1): ?>
                    <a href="<?php echo site_url('admin/user-category/add'); ?>" class="btn btn-primary btn-sm">Add user category</a>
                <?php endif; ?>
                        ...
                        <td class="td-action">
                            ...
                            <ul class="dropdown-menu ul-action" role="menu">
                                <?php if (isset($_updated) == 1): ?>
                                    <li>
                                        <a href="<?php echo site_url('admin/user-category/edit/{{row.id}}'); ?>">
...
<script>
var app = angular.module('user_categoryModule', ['smart-table', 'oitozero.ngSweetAlert', 'ui.bootstrap']);
...
app.factory('Resource', ['$q', '$filter', '$timeout', '$http', function ($q, $filter, $timeout, $http) {
    ...
    function getPage(start, number, params) {
        ...
        var getData = $http.get("<?php echo base_url('admin/user_category/get_data'); ?>")
...
app.controller('user_categoryController', ['Resource', '$scope', 'SweetAlert', '$http', '$uibModal',
    ...
    $scope.removeItem = function removeItem(row) {
        ...
        function (isConfirm) {
            if (isConfirm) {
                ...
                if (index !== -1) {
                    $http.delete("<?php echo base_url('admin/user_category/delete'); ?>" + "/" + row.id);
